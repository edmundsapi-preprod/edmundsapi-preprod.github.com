...
### URL
    ...
    https://api.edmunds.com/api/inventory/v2/inventories?zipcode={zipcode}&api_key={api_key}&fmt=json
    ...
    <body>
        ...
        <script>
            window.sdkAsyncInit = function() {
                ...
                // Fire the API call
                res.api('/api/inventory/v2/inventories?zipcode=90404', options, success, fail);
